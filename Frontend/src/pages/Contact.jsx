            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="grid sm:grid-cols-2 gap-5">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-1 focus:ring-orange-500 focus:border-orange-500 transition"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows="5"
                  className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-1 focus:ring-orange-500 focus:border-orange-500 transition resize-none"
      ...
      <section className="border-t border-gray-100 py-12 bg-white">
        <div className="container mx-auto px-4 text-center max-w-2xl">
          <p className="text-gray-500 text-sm">
            Prefer instant help? Call us at <span className="text-gray-900 font-medium">+1 (555) 123-4567</span>
          </p>
        </div>
      </section>
    </div>
