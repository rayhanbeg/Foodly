            ...
            {contactMethods.map((method, idx) => (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-neutral-600 text-sm mt-1">{method.value}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="border-t border-neutral-200 py-12 bg-white">
        <div className="container mx-auto px-4 text-center max-w-2xl">
          <p className="text-neutral-500 text-sm">
            Prefer instant help? Call us at <span className="text-neutral-900 font-medium">+1 (555) 123-4567</span>
          </p>
        </div>
      </section>
    </div>
