  ...
  return (
    <div className="min-h-screen bg-white">
      <section className="section container-fluid">
        ...
        >
          <h1 className="text-4xl sm:text-5xl font-bold mb-8 text-gray-900">Terms & Conditions</h1>
          <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">3. Order Placement</h2>
              <p>
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">6. Cancellation & Refunds</h2>
              <p>
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">9. Third-Party Content</h2>
              <p>
