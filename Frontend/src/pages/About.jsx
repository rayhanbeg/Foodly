    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center max-w-3xl">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl font-bold tracking-tight text-gray-900 mt-4 mb-4">
      ...
      <section className="py-16 md:py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900">The faces behind Foodly</h2>
      ...
      <section className="border-t border-gray-100 py-16 bg-white">
        <div className="container mx-auto px-4 text-center max-w-2xl">
          <h2 className="text-2xl font-semibold text-gray-900 mb-2">Ready to taste the difference?</h2>
