      ...
      <div className="container-fluid">
        ...
        >
          <div className="max-w-xl">
            ...
            <h2 className="mt-3 text-3xl md:text-4xl font-bold">Bring restaurant-quality meals to your door.</h2>
          ...
          <div className="flex flex-wrap gap-3">
            <Link to="/menu" className="bg-white text-neutral-900 px-6 py-3 rounded-xl font-semibold">Start ordering</Link>
            <Link to="/register" className="border border-white/30 px-6 py-3 rounded-xl font-semibold text-white">Create account</Link>
          </div>
        </motion.div>
      </div>
    </section>
